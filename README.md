...
VALUES
('M4125', 'Otmane^Elkastali3', '1945-08-04', 'M', '820 JORIE BLVD^^CHICAGO^IL^60523', '(314)555-1212', '20-98-4000', NULL);
...
2. Connect to the broker container. First, get the IP address of the service:
docker inspect container_broker


3. Start a session in the broker container:
